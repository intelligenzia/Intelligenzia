...
const validSlugs = ['a-c', 'd-f', 'g-i', 'j-l', 'm-o', 'p-r', 's-u', 'v-o'];
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  if (!page) {
    return {
      title: `Sanasto ${sectionTitles[slug]} | Kognitiotieteen sanasto`,
    };
  }
      ...
      <div className="relative mx-auto max-w-3xl xl:max-w-4xl">
        ...
        <article>
          ...
          <nav className="mb-6 text-sm">
            <Link href="/sanasto" className="text-muted-foreground hover:text-foreground">
              Sanasto
            </Link>
